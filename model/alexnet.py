...
class AlexNet(object):
    ...
    def create(self):
        ...
        fc6 = fc(self.flattened, 6*6*256, 4096, name='fc6')
        ...
        self.fclat = fc(dropout7, 4096, 48, name = 'fclat', relu=False, sigmoid=True)
        
        # 8th Layer: FC and return unscaled activations
        self.fc8 = fc(self.fclat, 48, self.num_classes, relu=False, name='fc8')
...
def fc(x, num_in, num_out, name, relu=True, sigmoid=False):
