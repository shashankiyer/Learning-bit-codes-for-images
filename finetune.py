...
if __name__ == '__main__':
    ...
    #exporter = tf.estimator.FinalExporter('timeseries', serving_input_receiver_fn)
    #eval_spec = tf.estimator.EvalSpec(input_fn=get_valid())#, exporters=[exporter])
    ...
    estimator.train(input_fn = get_train(params) , max_steps = 1000)
